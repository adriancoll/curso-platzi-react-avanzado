  ...
  return (
    ...
    >
      <defs>
        ...
        >
          <stop offset={0} stopColor='#e0dcb8' />
          <stop offset={0.17} stopColor='#aca730' />
          <stop offset={0.34} stopColor='#4f563b' />
          <stop offset={0.51} stopColor='#9db189' />
          <stop offset={0.68} stopColor='#60a363' />
          <stop offset={0.85} stopColor='#2c8c14' />
          <stop offset={1} stopColor='#0a4308' />
        </linearGradient>
        <filter
